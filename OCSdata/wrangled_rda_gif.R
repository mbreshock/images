...
step4 = image_read("~/Desktop/Michael/images/OCSdata/wrangled_rda_files.png")

# making vector of each image
img = c(step1, step2, step3, step4, step4)

# animating
rda_gif =  image_animate(img, delay = 100, optimize = TRUE)

# saving to file
image_write(rda_gif,"~/Desktop/Michael/images/OCSdata/wrangled_rda_directory.gif")
